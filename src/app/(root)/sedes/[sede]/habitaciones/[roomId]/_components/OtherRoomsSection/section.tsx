              ...
              (data, i) =>
                i < 3 && (
                  ...
                  >
                    ...
                    >
                      <div
                        className={`cursor-pointer relative before:content-[''] before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 before:bg-[rgba(0,0,0,0.7)] before:opacity-0 hover:before:opacity-100 before:transition-all before:duration-300 ${styles["container"]}`}
                      >
                        <div
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <hr className="h-[1px] border-zinc-800" />
                      <p className="text-base text-zinc-300">{data.target}</p>
